...
////  masterMind
////
////  Created by Elena Zobak on 4/19/23.
////
//
//import UIKit
//
//
//class WinAlertPopUp: UIViewController {
//    
...
//        super.viewDidLoad()
//        if let codeValue = fetchedCode {
//               // Set the text of messageLabel with codeValue
//               messageLabel.text = "The number was: \(codeValue)"
//           } else {
//               // Handle case when code is not set
//               messageLabel.text = "Code value not set"
//           }
//        configView()
